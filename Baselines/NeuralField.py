...
from Baselines.crom_util import *
...
class CROMnet(pl.LightningModule):
    def __init__(self, data_format, preprop_params, example_input_array, initial_lr=1e-4, batch_size=16, lbl=6, scale_mlp=10, ks=3,
                 strides=2, siren_enc=False, siren_dec=False, enc_omega_0=0.3, dec_omega_0=30, verbose=False, lr=[10], epo=[100], 
                 schedule='explicit', loaded_from=None):
