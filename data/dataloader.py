...
class OneStepDataset(pyg.data.Dataset):
    def __init__(self, data_path=None, metadata_path=None, window_length=7, noise_std=0.0, return_pos=False, sampling = False, sampling_strategy='random', graph_type='radius', sampling_percent_lb = 0.20, sampling_percent_ub=0.33, radius=None):
        super().__init__()
...
class RolloutDataset(pyg.data.Dataset):
    def __init__(self, data_path, metadata_path, window_length=7, sampling=False, sampling_strategy='random', graph_type='radius', mesh_size=90, radius=None):
        super().__init__()
